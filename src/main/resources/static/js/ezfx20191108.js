...
//	var accountInfo = new Object();
	...
	var getUrl = url + '/rest/accountInfo';
	...
	jQuery.ajax({
		...
		success:function(data){
			...
			divText = divText + userId+data.username;
			divText = divText + userName+data.fullname;
			divText = divText + brno+data.brno;
